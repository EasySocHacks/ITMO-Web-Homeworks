...
public class UserService {
    ...
    public void validateRegistration(User user, String password, String passwordConfirmation) throws ValidationException {
        ...
        if (user.getEmail().length() - user.getEmail().replaceAll("@", "").length() != 1) {
            throw new ValidationException("Enter a correct email");
        }
        ...
        if (Strings.isNullOrEmpty(passwordConfirmation)) {
            throw new ValidationException("Password confirmation required");
        }
        if (!password.equals(passwordConfirmation)) {
            throw new ValidationException("Password and confirmation must be equals");
        }
    }
    ...
    public User validateAndFindByLoginAndPasswordOrEmail(String loginOrEmail, String password) throws ValidationException {
